...
<div class="container mt-5">
    <div class="row d-flex justify-content-center">
        <div class="col-md-7">
            ...
            <h4 class="text-center"><b>APLIKASI INI DIBUAT OLEH : </h4>
                <div class="text-center"> <img src="pas_foto.jpeg" width="100" class="square"> </div>
                <div class="text-center mt-3"> <span class="bg-secondary p-1 px-4 rounded text-white">Profile</span>
                    <h5 class="mt-2 mb-0"></h5> 
                    <h6>Nama &nbsp;: Fajriyah Mayzura Agustin</h6>
